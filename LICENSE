INTEGRITY SOURCE LICENSE (ISL) v0.2

Preamble
--------
The Integrity Source License (ISL) affirms the right to repair, the freedom to modify and redistribute, and the obligation to preserve openness and integrity. This license prohibits closed-source forking, data harvesting, and misuse of the Work in ways that undermine its spirit. It is designed to protect creators, empower users, and sustain a resilient, open-source ecosystem.
...
- Name the original creator in documentation, README files, and user-facing interfaces where appropriate.
- Include a copy of this license or another license in compliance with Section 4 in all redistributions and forks.

Section 4: Copyleft and License Continuity
------------------------------------------
All Derivative Works must be licensed under ISL (the version that the original Work is using or any later version) or a compatible license that:
...
------------------------------------
If You violate any term of this license, Your rights are automatically terminated unless the violation is corrected within 30 days of notification by the Original Author or other related person.
...
These elements stated in Section 9 are not required but are strongly recommended to preserve the spirit of the ISL and to guide users looking to fork, modify, and redistribute the Work.
